...
- Crie um projeto react com create-vite: `npm init --yes vite@latest "webcontabilidadedvd.client" -- --template=react  --no-rolldown --no-immediate --eslint`.
...
- Criar o arquivo de projeto (`webcontabilidadedvd.client.esproj`).
